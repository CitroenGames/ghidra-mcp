...
- `search_raw_strings` - Search exact literal bytes in loaded, initialized memory
...
- `reset_function_prototype` - Reset a function's stored prototype to Ghidra's default/inferred state without supplying a guessed signature
...
- `server_repository_file` - Get file info
