...
public class GhidraServerManager {
    ...
    public String getFileInfo(String repoName, String filePath) {
        ...
        try {
            ...
            sb.append(", \"type\": \"").append(escapeJson(item.getContentType())).append("\"");
            sb.append(", \"version\": ").append(item.getVersion());
            sb.append(", \"lifecycle_scope\": \"repository_only\"");
            sb.append(", \"project_file_state_supported\": false");
            sb.append(", \"project_file_state_status\": \"not_supported\"");
            sb.append(", \"project_file_state_hint\": \"Open the shared project, then call /project_file_status for local checkout, latest-version, dirty, busy, and merge state.\"");
            sb.append("}");
            return sb.toString();
        } catch (Exception e) {
            lastError = e.getMessage();
