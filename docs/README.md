...
- Read `SHARED_PROJECT_VERSION_CONTROL.md` to check out, save, and check in an
  open shared-project file through guarded MCP tools.
...
├── README.md
├── UPDATING.md
├── SHARED_PROJECT_VERSION_CONTROL.md
