...
MCP server bridging Ghidra reverse engineering with AI tools. 276 MCP tools for binary analysis.
...
- **Authoritative repo snapshot**: `tests/endpoints.json` (276 endpoints, categories, descriptions)
