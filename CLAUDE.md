...
MCP server bridging Ghidra reverse engineering with AI tools. 275 MCP tools for binary analysis.
...
- **Authoritative repo snapshot**: `tests/endpoints.json` (275 endpoints, categories, descriptions)
